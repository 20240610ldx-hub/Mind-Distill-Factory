...
<!--
  注意：此为开发模板。最终交付物必须是合并了中英双语的单个 SKILL.md 文件。
  Claude Code 只识别每个 skill 目录下的 SKILL.md（严格大小写匹配）。
  当前质量参考请看 gallery/wang-yangming/SKILL.md 与 gallery/sun-tzu/SKILL.md。
  gallery/charlie-munger/SKILL.md 仅为 legacy 旧示例。
-->
...
**理念：** {principle_explanation_zh — 2-3 句白话解释}
