...
DEFAULT_PARTICIPANTS_DIR = Path("debate_arena") / "skills"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    run.add_argument("--skill-a", help="Path to Side A SKILL.md. Defaults to debate_arena/skills/skill_a/SKILL.md.")
    run.add_argument("--skill-b", help="Path to Side B SKILL.md. Defaults to debate_arena/skills/skill_b/SKILL.md.")
...
def _config_from_args(args: argparse.Namespace) -> DebateConfig:
    ...
    participants_dir = Path(
        ...
        or DEFAULT_PARTICIPANTS_DIR
    )
    skill_a_path = args.skill_a or input_section.get("skill_a_path") or participants_dir / "skill_a" / "SKILL.md"
    skill_b_path = args.skill_b or input_section.get("skill_b_path") or participants_dir / "skill_b" / "SKILL.md"
